...
const bem = createNamespace('sampung')
...
describe('Resolve Bem with ([test])', () => {
  it('Resolve Bem', () => {
    expect(bem(['test'])).toBe('sam-sampung sam-sampung--test')
  })
...
describe('Resolve Bem with (button, [disabled])', () => {
  it('Resolve Bem', () => {
    expect(bem('button', ['disabled'])).toBe(
...
describe('Resolve Bem with (button, [disabled, loading])', () => {
  it('Resolve Bem', () => {
    expect(bem('button', ['disabled', 'loading'])).toBe(
...
describe('Resolve Bem with (button)', () => {
  it('Resolve Bem', () => {
    expect(bem('button')).toBe('sam-sampung-button')
  })
